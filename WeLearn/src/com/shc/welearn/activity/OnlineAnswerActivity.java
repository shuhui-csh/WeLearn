...
public class OnlineAnswerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mWebView = (WebView) findViewById(R.id.online_answer_webview);
		initTitleBar();
		// 创建进度对话框
		progressDialog = ProgressDialog.show(OnlineAnswerActivity.this, null,
	...
	private void initTitleBar() {
		...
		title_text.setText(getResources().getString(R.string.online_answer));
		title_img
